...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference("Seat.count") do
      post seats_url, params: { seat: { brand_id: @seat.brand_id, link: @seat.link, name: @seat.name } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { brand_id: @seat.brand_id, link: @seat.link, name: @seat.name } }
